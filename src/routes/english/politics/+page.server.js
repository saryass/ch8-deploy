...
export async function load() {
	try {
		...
		return {  
			zanyar,
			title: "Latest Politics News | Ch8 News",
            description: "Stay updated with the latest politics news on Ch8 News. Get the most recent articles and insights on political events and issues."
		};
		...
		return {
			...
			description: "An error occurred while fetching the politics news data on Ch8 News."
		};
	}
}
